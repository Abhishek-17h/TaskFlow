    ...
    <div className="flex items-center justify-between bg-white px-4 py-3  dark:bg-black">
      ...
      <div className="flex items-center gap-8">
        <div className="relative flex h-min w-[200px]">
          ...
          <input
            className="focus-border-transparent focus-outline-none w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 dark:bg-gray-700 dark:text-white dark:placeholder-white"
            type="search"
            placeholder="Search..."
          />
        </div>
